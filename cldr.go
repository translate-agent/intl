...
func defaultNumberingSystem(locale language.Tag) numberingSystem {
  ...
  case s == "az-Arab", strings.HasPrefix(s, "az-Arab-"), s == "bgn", strings.HasPrefix(s, "bgn-"), s == "fa", strings.HasPrefix(s, "fa-"), s == "ks", strings.HasPrefix(s, "ks-"), s == "lrc", strings.HasPrefix(s, "lrc-"), s == "mzn", strings.HasPrefix(s, "mzn-"), s == "pa-Arab", strings.HasPrefix(s, "pa-Arab-"), s == "ps", strings.HasPrefix(s, "ps-"), s == "ur-IN", strings.HasPrefix(s, "ur-IN-"), s == "uz-Arab", strings.HasPrefix(s, "uz-Arab-"):
